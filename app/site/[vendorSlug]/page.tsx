...
import { getVendorBySlug, getAllVendorSlugs } from '@/lib/vendors';
import { getProductsByCategory, filterAndSortProducts, paginateProducts } from '@/lib/api';
...
export default async function VendorPage({ params, searchParams }: PageProps) {
  ...
  const allProducts = await getProductsByCategory(vendor.category);
